(function() {
  ...
  Stateful = (function(_super) {
    ...
    Object.defineProperty(Stateful.prototype, 'state', {
      get: function() {
        return this.__state;
      },
      set: function(state) {
    ...
    Stateful.state = function(stateName, config) {
    ...
    function Stateful(config) {
      Stateful.__super__.constructor.call(this, config);
    ...
    Stateful.prototype.changeState = function(to) {
      ...
      if (from !== void 0 && !this.isValidStateChange(from, to)) {
        throw new Error("Bad state change: can't change from the '" + this.state + "' state to '" + to + "' state on " + this);
      }
      this.__state = to;
